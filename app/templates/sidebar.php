...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="<?php echo is_active('ruang'); ?> nav-item"><a href="?page=ruang"><i class="feather icon-check-square"></i><span class="menu-title" data-i18n="Ruang">Ruangan</span></a>
      </li>

      <li class="<?php echo is_active('obat'); ?> nav-item"><a href="?page=obat"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Obat">Farmasi</span></a>
      </li>
